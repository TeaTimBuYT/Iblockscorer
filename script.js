    ...
    function displayMatchDetails(match) {
        if (match.photo) {
            display.innerHTML = `
                ...
                <button id="backToMatches">Back</button>
            `;
        } else {
            display.innerHTML = `
                <div class="match-summary">
        ...
        const backToMatchesButton = document.getElementById("backToMatches");
        backToMatchesButton.addEventListener("click", function () {
            display.innerHTML = ""; // Clear the display
            content.style.display = "block"; // Show the main menu
        });
    }
});